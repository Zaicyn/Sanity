...
void createInstance(VulkanContext& ctx) {
    ...
    appInfo.pApplicationName = "V20 Black Hole Renderer";
    appInfo.applicationVersion = VK_MAKE_VERSION(2, 0, 0);
    appInfo.pEngineName = "Squaragon";
    ...
    std::cout << "[V20] Vulkan instance created" << std::endl;
}
...
void destroyInstance(VulkanContext& ctx) {
    if (enableValidationLayers && ctx.debugMessenger != VK_NULL_HANDLE) {
